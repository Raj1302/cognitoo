      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-[15px] leading-relaxed">
            Our talented team of experts is dedicated to delivering excellence in every project
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {teamMembers.map((member) => (
            <div 
              key={member.name}
              className="backdrop-blur-xl bg-white/80 border border-gray-200/80 rounded-xl shadow-lg transition-all duration-300 hover:shadow-xl hover:bg-white/90 group overflow-hidden"
            >
